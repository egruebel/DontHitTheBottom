...
class IOController():
    ...
    def echo_callback(self, depth, keeldepth, sv):
        #keeldepth not used
        self.echosounder_depth = depth
        self.echosounder_sv = sv

    def io_device_callback(self, depth, pressure, altitude, sv, sv_avg):
    ...
    def __init__(self):
        self.echosounder = EchoSounder(AppSettings.echosounder_udp_port, self.echo_callback)
        #self.io_device
